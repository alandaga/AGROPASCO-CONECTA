...
const APP_CONFIG = {
  ...
  /**
   * ============================================================================
   * INTEGRACIÓN CON FIREBASE CLOUD FIRESTORE (BASE DE DATOS GLOBAL EN TIEMPO REAL)
   * ============================================================================
   * Permite que todas las cosechas que registren los productores se almacenen en
   * la nube de Google Firebase y aparezcan EN TIEMPO REAL en las pantallas de
   * todos los usuarios y compradores del mundo, sin necesidad de recargar la página.
   *
   * PASOS PARA PEGAR TUS CREDENCIALES:
   * 1. Ingresa a la consola: https://console.firebase.google.com/
   * 2. Crea un proyecto nuevo (ej. "agropasco-conecta-2026").
   * 3. En el menú izquierdo ve a: Compilación > Firestore Database > Crear base de datos.
   *    - Elige ubicación (ej. us-central1 o southamerica-east1) y selecciona "Modo de prueba".
   * 4. En Configuración del proyecto (icono de tuerca) > Tus apps > Selecciona Web (</>).
   * 5. Copia los valores y pégalos en los campos de abajo:
   */
  enableFirebase: true,
  firebaseConfig: {
  ...
  firestoreCollection: "productos_cosechas",

  /**
   * ============================================================================
   * INTEGRACIÓN CON GOOGLE SHEETS EN VIVO (OPCIONAL)
   * ============================================================================

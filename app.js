...
(function () {
  ...
  const DOM = {
    ...
    linkGoogleForm: document.getElementById("link-google-form"),
...
¡Muchas gracias por apoyar a las familias campesinas de Pasco! 🇵🇪`;
  ...
  /* ============================================================================
     10. MODAL PARA EL AGRICULTOR ("SOY PRODUCTOR")
     ============================================================================ */
  function openProducerModal() {
    if (!DOM.producerModal) return;
    
    // Configurar enlaces desde config.js
    if (DOM.linkGoogleForm) {
      DOM.linkGoogleForm.href = APP_CONFIG.googleFormsRegisterUrl;
    }
